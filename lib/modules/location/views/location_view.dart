...
class LocationView extends GetView<LocationController> {
            ...
            FlutterMap(
              ...
              options: MapOptions(
                initialCenter: controller.currentLatLng.value ?? 
                  LatLng(-6.2088, 106.8456), // Default Jakarta
                initialZoom: 15.0,
                minZoom: 5.0,
                maxZoom: 18.0,
              ),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Action Buttons: removed duplicate buttons so only appbar button remains
  ...
  Widget _buildModeButton(String label, IconData icon, String mode, Color color) {
    return Obx(() {
